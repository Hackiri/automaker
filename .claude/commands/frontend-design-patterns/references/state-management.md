...
export const useModalStore = create<ModalState>((set) => ({
  modals: {},
  actions: {
    open: (id) => set((state) => ({ modals: { ...state.modals, [id]: true } })),
    close: (id) => set((state) => ({ modals: { ...state.modals, [id]: false } })),
    toggle: (id) =>
      set((state) => ({
...
// Selector factory
export const useModal = (id: string) => useModalStore((state) => state.modals[id] ?? false);
...
// Selectors
export const useCheckoutStep = () => useCheckoutFormStore((state) => state.step);
export const useShippingAddress = () => useCheckoutFormStore((state) => state.shippingAddress);
export const useBillingAddress = () => useCheckoutFormStore((state) => state.billingAddress);
export const useCheckoutFormActions = () => useCheckoutFormStore((state) => state.actions);
```
